...
CREATE OR REPLACE FUNCTION cancel_reservation(p_reservation_id UUID, p_password_hash TEXT)
RETURNS BOOLEAN
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public
...
GRANT EXECUTE ON FUNCTION cancel_reservation(UUID, TEXT) TO anon, authenticated;
