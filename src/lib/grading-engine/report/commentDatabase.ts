...
/**
 * CT 진단검사 (초등 개념구조화) 코멘트
 */
const CT_COMMENTS: Record<string, Record<PerformanceLevel, AreaComment>> = {
  '소수': {
    EXCELLENT: {
      area: '소수',
      level: 'EXCELLENT',
      comment: '소수의 개념을 완벽하게 이해하고 있습니다. 소수 판별과 활용 능력이 우수합니다.',
      learningTips: [
        '소인수분해 심화 문제에 도전하세요',
        '에라토스테네스의 체를 활용한 문제를 풀어보세요',
        '중등 수학의 소수 활용 문제를 선행하세요',
      ],
    },
    GOOD: {
      area: '소수',
      level: 'GOOD',
      comment: '소수 개념을 잘 이해하고 있습니다. 응용력을 조금 더 키우면 좋겠습니다.',
      learningTips: [
        '소수 판별 연습을 꾸준히 하세요',
        '100까지의 소수를 빠르게 찾는 연습을 하세요',
        '소수를 활용한 문제를 많이 풀어보세요',
      ],
    },
    AVERAGE: {
      area: '소수',
      level: 'AVERAGE',
      comment: '소수의 기본 개념은 알고 있으나 활용에 어려움이 있습니다.',
      learningTips: [
        '소수의 정의를 다시 확인하세요',
        '1부터 50까지 소수를 외워보세요',
        '소수 판별 방법을 정확히 익히세요',
    ...
    WEAK: {
      area: '소수',
      level: 'WEAK',
      comment: '소수 개념 이해가 부족합니다. 기초부터 다시 학습이 필요합니다.',
      learningTips: [
        '약수의 개념부터 복습하세요',
        '소수의 정의를 명확히 이해하세요',
        '작은 수부터 소수인지 판별하는 연습을 하세요',
      ],
    },
    CRITICAL: {
      area: '소수',
      level: 'CRITICAL',
      comment: '소수의 기초 개념이 매우 부족합니다. 약수 개념부터 체계적인 복습이 필요합니다.',
      learningTips: [
        '곱셈과 나눗셈의 관계를 복습하세요',
        '약수의 개념을 먼저 확실히 익히세요',
        '선생님의 도움을 받아 기초부터 학습하세요',
      ],
    },
  },
  '제곱수': {
    EXCELLENT: {
      area: '제곱수',
      level: 'EXCELLENT',
      comment: '제곱수 개념을 완벽히 이해하고 있습니다. 제곱근 학습 준비가 되어 있습니다.',
      learningTips: [
        '20까지의 제곱수를 암기하세요',
        '제곱근 개념을 선행해보세요',
        '제곱수의 성질을 활용한 심화 문제에 도전하세요',
      ],
    },
    GOOD: {
      area: '제곱수',
      level: 'GOOD',
      comment: '제곱수를 잘 이해하고 있습니다. 더 큰 수의 제곱도 연습해보세요.',
      learningTips: [
        '15까지의 제곱수를 암기하세요',
        '제곱수를 활용한 다양한 문제를 풀어보세요',
        '제곱수와 소인수분해의 관계를 학습하세요',
      ],
    },
    AVERAGE: {
      area: '제곱수',
      level: 'AVERAGE',
      comment: '기본적인 제곱수는 알고 있으나 활용 능력이 부족합니다.',
      learningTips: [
        '10까지의 제곱수를 확실히 외우세요',
        '제곱의 의미를 다시 이해하세요',
        '제곱수 관련 문제를 많이 풀어보세요',
    ...
    WEAK: {
      area: '제곱수',
      level: 'WEAK',
      comment: '제곱수 개념 이해가 부족합니다. 거듭제곱의 기초부터 학습이 필요합니다.',
      learningTips: [
        '같은 수를 여러 번 곱하는 연습을 하세요',
        '기본 제곱수(1, 4, 9, 16, 25)를 외우세요',
        '제곱의 의미를 정확히 이해하세요',
      ],
    },
    CRITICAL: {
      area: '제곱수',
      level: 'CRITICAL',
      comment: '제곱수의 기초가 매우 부족합니다. 곱셈 연산부터 체계적인 복습이 필요합니다.',
      learningTips: [
        '구구단을 완벽히 암기하세요',
        '같은 수끼리 곱하는 연습을 하세요',
        '선생님의 도움을 받아 기초부터 학습하세요',
  ...
  '개념 서술': {
    EXCELLENT: {
      area: '개념 서술',
      level: 'EXCELLENT',
      comment: '수학 개념을 정확하게 서술할 수 있습니다. 논리적 사고력이 우수합니다.',
      learningTips: [
        '수학적 증명에 도전해보세요',
        '자신만의 방식으로 개념을 설명하는 연습을 하세요',
        '서술형 문제에 적극 도전하세요',
      ],
    },
    GOOD: {
      area: '개념 서술',
      level: 'GOOD',
      comment: '개념 서술 능력이 양호합니다. 더 정확한 용어 사용을 연습하세요.',
      learningTips: [
        '수학 용어를 정확히 사용하는 연습을 하세요',
        '친구에게 개념을 설명해보세요',
        '풀이 과정을 글로 써보는 연습을 하세요',
      ],
    },
    AVERAGE: {
      area: '개념 서술',
      level: 'AVERAGE',
      comment: '개념은 이해하고 있으나 서술 표현에 어려움이 있습니다.',
      learningTips: [
        '기본 개념을 말로 설명하는 연습을 하세요',
        '서술형 문제의 모범 답안을 참고하세요',
        '풀이 과정을 단계별로 쓰는 연습을 하세요',
      ],
    },
    WEAK: {
      area: '개념 서술',
      level: 'WEAK',
      comment: '개념 서술 능력이 부족합니다. 기본 개념 이해와 표현력 향상이 필요합니다.',
      learningTips: [
        '기본 개념을 다시 정리하세요',
        '수학 일기를 써보세요',
        '쉬운 서술형 문제부터 연습하세요',
    ...
    CRITICAL: {
      area: '개념 서술',
      level: 'CRITICAL',
      comment: '개념 서술의 기초가 매우 부족합니다. 기본 개념 이해부터 시작이 필요합니다.',
      learningTips: [
        '핵심 개념을 암기하세요',
        '선생님의 설명을 따라 말해보세요',
        '기초 개념부터 차근차근 학습하세요',
  ...
  '소인수분해': {
    EXCELLENT: {
      area: '소인수분해',
      level: 'EXCELLENT',
      comment: '소인수분해를 완벽하게 수행할 수 있습니다. 중등 수학 준비가 잘 되어 있습니다.',
      learningTips: [
        '큰 수의 소인수분해에 도전하세요',
        '최대공약수, 최소공배수 활용 문제를 풀어보세요',
        '중1 수학의 소인수분해 단원을 선행하세요',
      ],
    },
    GOOD: {
      area: '소인수분해',
      level: 'GOOD',
      comment: '소인수분해를 잘 수행합니다. 복잡한 수에서도 정확성을 유지하세요.',
      learningTips: [
        '다양한 수의 소인수분해를 연습하세요',
        '소인수분해 결과를 검산하는 습관을 기르세요',
        '최대공약수와 최소공배수 구하기를 연습하세요',
      ],
    },
    AVERAGE: {
      area: '소인수분해',
      level: 'AVERAGE',
      comment: '기본적인 소인수분해는 가능하나 복잡한 수에서 어려움이 있습니다.',
      learningTips: [
        '나눗셈을 이용한 소인수분해 방법을 연습하세요',
        '작은 소수(2, 3, 5, 7)로 나누는 연습을 하세요',
        '소인수분해 문제를 많이 풀어보세요',
      ],
    },
    WEAK: {
      area: '소인수분해',
      level: 'WEAK',
      comment: '소인수분해 이해가 부족합니다. 소수와 약수 개념부터 복습이 필요합니다.',
      learningTips: [
        '소수의 개념을 다시 복습하세요',
        '나눗셈 연산을 정확히 하세요',
        '쉬운 수부터 소인수분해를 연습하세요',
    ...
    CRITICAL: {
      area: '소인수분해',
      level: 'CRITICAL',
      comment: '소인수분해의 기초가 매우 부족합니다. 소수 개념부터 체계적인 학습이 필요합니다.',
      learningTips: [
        '소수가 무엇인지부터 학습하세요',
        '약수와 배수 개념을 복습하세요',
        '선생님의 도움을 받아 기초부터 학습하세요',
  ...
  '약수의 개수': {
    EXCELLENT: {
      area: '약수의 개수',
      level: 'EXCELLENT',
      comment: '약수의 개수를 빠르고 정확하게 구할 수 있습니다. 공식 활용 능력이 우수합니다.',
      learningTips: [
        '약수의 개수 공식을 다양한 문제에 적용하세요',
        '완전수, 과잉수 등 심화 개념을 학습하세요',
        '약수의 합 구하기도 연습하세요',
      ],
    },
    GOOD: {
      area: '약수의 개수',
      level: 'GOOD',
      comment: '약수의 개수 구하기를 잘 수행합니다. 공식을 더 빠르게 적용하는 연습을 하세요.',
      learningTips: [
        '약수의 개수 공식을 암기하세요',
        '다양한 수의 약수 개수를 구해보세요',
        '소인수분해와 연결지어 학습하세요',
    ...
    AVERAGE: {
      area: '약수의 개수',
      level: 'AVERAGE',
      comment: '약수의 개수를 구할 수 있으나 시간이 오래 걸립니다. 공식 활용을 연습하세요.',
      learningTips: [
        '약수를 모두 나열하는 방법을 연습하세요',
        '약수의 개수 공식을 이해하고 적용하세요',
        '작은 수부터 약수 개수 구하기를 연습하세요',
      ],
    },
    WEAK: {
      area: '약수의 개수',
      level: 'WEAK',
      comment: '약수의 개수 구하기가 어렵습니다. 약수의 기본 개념부터 복습이 필요합니다.',
      learningTips: [
        '약수의 정의를 다시 확인하세요',
        '나눗셈으로 약수 찾는 방법을 익히세요',
        '작은 수의 약수를 모두 찾는 연습을 하세요',
      ],
    },
    CRITICAL: {
      area: '약수의 개수',
      level: 'CRITICAL',
      comment: '약수의 개수 구하기 기초가 매우 부족합니다. 약수 개념부터 체계적인 학습이 필요합니다.',
      learningTips: [
        '약수가 무엇인지부터 학습하세요',
        '나눗셈 연산을 정확히 하세요',
        '선생님의 도움을 받아 기초부터 학습하세요',
