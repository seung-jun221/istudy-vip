...
const TEST_SPECIFIC_ROADMAPS: Record<TestType, Record<PerformanceLevel, Roadmap>> = {
  CT: {
    EXCELLENT: {
      step1: '초등 수학 개념이 탄탄합니다. 중1-1 (정수, 방정식) 과정을 선행하세요.',
      step2: '중1 수학을 빠르게 학습하고, 사고력 수학 문제에 도전해보세요.',
      step3: 'MONO 진단검사를 응시하여 중등 수학 실력을 점검하세요.',
    },
    GOOD: {
      step1: '취약 영역을 보완하고, 초등 심화 문제로 응용력을 키우세요.',
      step2: '중1-1 기초 과정(정수, 문자와 식)을 예습하세요.',
      step3: '약점 보완 후 MONO 진단검사에 도전하세요.',
    },
    AVERAGE: {
      step1: '현재 약점 영역을 집중 보완하고, 기본 문제를 반복 연습하세요.',
      step2: '초등 5-6학년 수학을 완벽히 이해한 후 중등 준비를 시작하세요.',
      step3: '기초가 탄탄해지면 초등 심화 학습 후 재응시를 권장합니다.',
    },
    WEAK: {
      step1: '초5-6 수학 개념을 다시 정리하고, 기초 문제부터 충분히 연습하세요.',
      step2: '약수, 배수, 분수 연산을 확실히 익히세요.',
      step3: '초등 개념 완성 후 CT 진단검사를 다시 응시하세요.',
    },
    CRITICAL: {
      step1: '초등 저학년 연산부터 다시 점검하고, 개념 학습에 집중하세요.',
      step2: '1:1 맞춤 학습으로 기본기를 천천히 다지세요.',
      step3: '기초 보완 후 다시 도전하세요.',
    },
  },
  ...
  CT: {
    EXCELLENT: {
      step1: '중등 수학의 기초 개념을 완벽히 갖추었습니다. 중1-1 과정을 본격적으로 선행하세요.',
      step2: '중1 수학(정수, 방정식, 함수)을 학습하며 중등 수학에 적응합니다.',
      step3: '중1 과정을 마스터하고 중2 수학 선행을 준비합니다.',
    },
    GOOD: {
      step1: '개념 이해가 양호합니다. 부족한 영역(소수, 약수 등)을 보완하며 중등 준비를 합니다.',
      step2: '초등 심화 문제와 중1 기초 개념을 병행 학습합니다.',
      step3: '중1-1 과정을 차근차근 선행하며 실력을 쌓습니다.',
    },
    AVERAGE: {
      step1: '소수, 약수, 배수의 기본 개념을 확실히 다집니다.',
      step2: '소인수분해와 최대공약수/최소공배수를 충분히 연습합니다.',
      step3: '초등 과정을 완벽히 이해한 후 중1 예습을 시작합니다.',
    },
    WEAK: {
      step1: '약수와 배수, 소수 개념부터 차근차근 복습합니다.',
      step2: '기본 문제를 반복 연습하며 자신감을 키웁니다.',
      step3: '초등 필수 개념을 완전히 이해한 후 다음 단계로 나아갑니다.',
    },
    CRITICAL: {
      step1: '초등 저학년 연산(곱셈, 나눗셈)부터 체계적으로 복습합니다.',
      step2: '1:1 맞춤 수업으로 약수, 배수 개념을 천천히 학습합니다.',
      step3: '초등 필수 개념을 완전히 이해하는 것이 목표입니다.',
    },
  },
};
