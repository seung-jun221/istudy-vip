...
import { TestType, QuestionInfo, TestPaper, AreaType, Difficulty } from '../types/index';
  ...
  private static readonly TEST_PAPERS: { [key in TestType]: TestPaper } = {
    MONO: {
      ...
      questions: [
        ...
        { questionNumber: 5, area: '수와 연산', difficulty: 'HIGH', score: 4.5, content: '72×a=b^2를 만족하는 a' },
    ...
    TRI: {
      ...
      questions: [
        ...
        { questionNumber: 19, area: '이차함수', difficulty: 'HIGH', score: 3.5, content: '최댓값 조건' },
        { questionNumber: 20, area: '이차함수', difficulty: 'HIGH', score: 4.0, content: '구간 최값' },
        { questionNumber: 21, area: '이차함수', difficulty: 'VERY_HIGH', score: 4.0, content: '구간 최값 케이스' },
        { questionNumber: 22, area: '이차함수', difficulty: 'VERY_HIGH', score: 4.0, content: '평행이동 + 최값' },
        { questionNumber: 23, area: '이차함수', difficulty: 'VERY_HIGH', score: 4.0, content: '교점 거리' },
        { questionNumber: 24, area: '이차함수', difficulty: 'EXTREME', score: 4.5, content: '판별식' },
        { questionNumber: 25, area: '이차함수', difficulty: 'EXTREME', score: 4.5, content: '함수값 부호' },
      ],
      areaScores: {
        '실수와 연산': 31.0,
        '다항식': 17.0,
